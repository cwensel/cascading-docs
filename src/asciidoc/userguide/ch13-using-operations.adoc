...
Operations typically require an input argument _multi-valued_ Tuple to act on.
And all Operations can return *_zero or more_* _multi-valued_ Tuple results -
except [classname]+Filter+, which simply returns a Boolean indicating whether to
